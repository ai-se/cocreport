...
\begin{tabular}{r@{~}|r@{~}|r@{~}|l@{~}|r@{~}l@{~}|r@{~}l@{~}|r@{~}l@{~}|r@{~}l@{~}|r@{~}l}
  ...
  ~\\
Albretcht  &   7         &   24   &   Projects from IBM   &   28   &       &   38   &   {\rone}   &   38   &   {\rone}   &   40   &   {\rone}   &   57   &   {\rfour}\\
...
non-COCOMO data sets. Red lines
show the errors for each data set (and the {\em shorter} the red lines, the {\em better} the effort estimator).
Red lines show the error 
discretized into 20th percentiles ranges from min to max (discretization performed seperately
for each data set).
An absent line denotes errors in the 0th to 20th percentile range for that data set.
The longest line denote largest
