...
\subsubsection{Column Reduction}\label{sect:prune}
...
say that noise {\em does not} change effect estimation.
That said, it should also be noted
that statistically, the effect of that noise is usually a small effect or not
a significant effect, as defined by the statistical tests of \tion{stats}.
...
and   column pruner of \tion{pruner}. \tion{XXX} also, for non-cocono data sets.
