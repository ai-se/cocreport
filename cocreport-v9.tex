...
\title{Software Effort Estimation: A Progress Report\titlenote{
...
\alignauthor Naveen Lekkalapudi\\
       \affaddr{CS, WVU, USA}\\
       \email{nalekkalapudi@mix.wvu.edu}
}}
...
%% }
This result has strong implications for current research practice. 
...
\footnote{This section is a reply to reviewers of a previous draft 
of this paper. See the headings Q1,Q2,Q3,Q4 for our replies to their comments
(Q1) the evaluation was made on the same dataset used to define the model and tailor
model parameters; (Q2) the model has a high number of parameters and a posteriori it can be used to
fit almost anything;
(Q3) a more realistic evaluation would imply using COCOMO on a new dataset NOT
...
(Q4)  it is quite troubling as if a large error on the input causes only small
