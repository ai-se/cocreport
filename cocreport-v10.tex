...
\lstset{
    ...
    emph={COCONUT,GUESSES,ASSESS,COCOMO2,PEEKER2,SAMPLE,WHERE,RIG}, emphstyle=\bfseries\color{Blue},
...
For example, all the learners studied in this paper can generate estimates
