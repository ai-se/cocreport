...
sets. For details on that data, see \fig{dataused} and \fig{types}). 
With one exception, our learning experiments do not use the data
that generated   standard COCOMO.
That exception is the  COC81 data, since this lets us the assess the  labor intensive methods used to generate standard COCOMO against new methods.  


\begin{figure}[!t]
\begin{center}
\includegraphics[width=3.2in]{datasets.png}
\end{center}
