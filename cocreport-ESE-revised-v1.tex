...
contains many corrections and extensions as directed by the
reviewers (including results from the Wingham method).
...
We read this paper (see http://goo.gl/6mZnk1). This paper
...
We have fixed that, on page \pageref{err:ed1}.
...
We have fixed that, on page \pageref{err:ed2}.

A third paper we are now writing
explores the effects of different evaluation
...
\item
As to the ``NASA bias'', certainly that exists but...
\bi
\item
...
for many other applications and many other clients.
\ei
...
using spectral-based clustering plus instance and feature selection, \textcolor{blue}{a recent ``baseline method'' proposed
...
\textcolor{blue}{\label{err:ed2} That said,
