...
learners were not changed. For example\footnote{GEORGE: @timm, let me know if figure 13 is decent enough or if we should do something else.}, figure \ref{fig:loc_e2} represents the results shown \ref{fig:loc} redone using \textit{e2} for measuring the error.
...
\item Further, at the suggestion of Reviewer\#2, we re-ran all our results
  ...
  you and the reviewers to inspect\footnote{George: \url{https://goo.gl/9KvvOa}}-- but it adds no information to this
...
Good catch. We use means (as recommended by Mittas     \& Angelis)\footnote{George: YES, we perform the recursive split looking to minimize the \textit{means}.}
...
\footnote{GEORGE XXX what do we have on this?. The results can be found here \url{https://goo.gl/5Vnocl}}
...
\footnote{George. what? The Coc81 has 63 projects. Our figure has a typo } 
...
your  inspection \footnote{GEORGE: \url{https://goo.gl/9KvvOa}}. In summary, the change of evaluation measure
